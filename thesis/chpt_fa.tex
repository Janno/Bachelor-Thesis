...
\subsection{Equivalence between DFA and NFA}
...
\begin{corollary} Let $r, s$ be regular expressions on $\Sigma$ and $A_1, A_2$ their corresponding, equivalent automata. 
    We then have that
    \begin{equation*}
...
\code{}{}{transitive_closure_dfa_to_regex}
\codeblock{}{}{transitive_closure_dfa_to_regex_correct_head}


This proof was by far the most technical proof presented in this thesis. 
