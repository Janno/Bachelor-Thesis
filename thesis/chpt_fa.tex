...
\codeblock{nfa_accept_lpath}{}{automata_nfa_accept_lpath_head}
...
\begin{definition}
    ...
    \begin{equation*}
        A_\emptyset := (\Sigma, \{T\}, T, \emptyset, \{(T, a, T) \; | \; a \in \Sigma\}).
    \end{equation*}
\end{definition}
...
\begin{proof}
    Let $w \in \Sigma^*$ be given.
    \todo{Same Proof as in Coq?}
\end{proof}
...
\begin{definition}
    ...
    \begin{equation*}
        A_\varepsilon := (\Sigma, \{t, f\}, t, \{t\}, \{(x, a, f) \; | \; x \in \{t, f\}, a \in \Sigma\}).
    \end{equation*}
\end{definition}
