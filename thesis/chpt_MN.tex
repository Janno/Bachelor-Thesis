...
\begin{definition} 
    ...
    $\equiv$ is a \textbf{Myhill relation} \cite{DBLP:books/daglib/0088160} on $L$ if and only if
...
Even with the fixed-point algorithm, this entire chapter is formalized in less than 650 lines.
